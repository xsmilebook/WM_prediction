...
targetStr_List = ['General', 'ADHD', 'Int']
# targetStr_List = ['age']
...
for i_str in range(num_targets):
    ...
    # Define path
    base_folder = os.path.join(ProjectFolder, target_str, 'V_siblilngs', 'RegressCovariates_RandomCV')
...
output_file = os.path.join(ProjectFolder, 'V_siblings_partial_results_total_multi_targets.mat')
output_csv_file = os.path.join(ProjectFolder, 'V_siblings_partial_results_total_multi_targets.csv')
boxplot_file = os.path.join(ProjectFolder, 'V_siblings_partial_results_forBoxplot_multi_targets.mat')
