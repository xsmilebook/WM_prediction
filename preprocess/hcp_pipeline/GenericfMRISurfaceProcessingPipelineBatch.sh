...
for Subject in $Subjlist; do
    echo "GenericfMRISurfaceProcessingPipelineBatch.sh: Processing Subject: $Subject"
    run_fmrisurface_subject "$StudyFolder" "$Subject" "$command_line_specified_run_local"
done
