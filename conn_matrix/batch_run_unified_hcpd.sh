...
MASK_OUTPUT_DIR="${PROJECT_ROOT}/data/HCPD/mri_data/wm_postproc"
FC_OUTPUT_DIR="${PROJECT_ROOT}/data/HCPD/fc_matrix/individual"
Z_OUTPUT_DIR="${PROJECT_ROOT}/data/HCPD/fc_matrix/individual_z"
